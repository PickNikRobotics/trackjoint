...
TEST_F(TrajectoryGenerationTest, EasyLinearTrajectory)
{
...
TEST_F(TrajectoryGenerationTest, OneTimestepDuration)
{
  ...
  desired_duration_ = 1 * timestep_;
  max_duration_ = 1 * timestep_;
...
TEST_F(TrajectoryGenerationTest, PositiveAndNegativeLimits)
{
  ...
  timestep_ = 0.001;
  desired_duration_ = 1800 * timestep_;
  max_duration_ = 1800 * timestep_;
