...
{
double CalculatePositionAccuracy(std::vector<trackjoint::KinematicState> goal_joint_states,
...
void VerifyVelAccelJerkLimits(std::vector<trackjoint::JointTrajectory>& trajectory,
