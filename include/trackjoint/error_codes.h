...
const std::unordered_map<uint, std::string> ERROR_CODE_MAP({ { NO_ERROR, "No error, trajectory generation was "
                                                                         "successful" },
                                                             { DESIRED_DURATION_TOO_SHORT, "Desired duration is too "
                                                                                           "short, cannot have less "
                                                                                           "than one timestep in a "
                                                                                           "trajectory" },
                                                             { MAX_DURATION_EXCEEDED, "Max duration was exceeded" },
                                                             { VELOCITY_EXCEEDS_LIMIT, "A velocity input exceeds the "
                                                                                       "velocity limit" },
                                                             { ACCEL_EXCEEDS_LIMIT, "An acceleration input exceeds the "
                                                                                    "acceleration limit" },
                                                             { MAX_DURATION_LESS_THAN_DESIRED_DURATION, "max_duration "
                                                                                                        "should not be "
                                                                                                        "less than "
                                                                                                        "desired_"
                                                                                                        "duration" },
                                                             { LIMIT_NOT_POSITIVE, "Vel/accel/jerk limits should be "
                                                                                   "greater than zero" },
                                                             { GOAL_POSITION_MISMATCH, "Mismatch between the final "
                                                                                       "position and the goal "
                                                                                       "position" },
                                                             { FAILURE_TO_GENERATE_SINGLE_WAYPOINT, "Failed to "
                                                                                                    "generate even a "
                                                                                                    "single new "
                                                                                                    "waypoint" },
                                                             { LESS_THAN_TEN_TIMESTEPS_FOR_STREAMING_MODE, "In "
                                                                                                           "streaming "
                                                                                                           "mode, "
                                                                                                           "desired "
                                                                                                           "duration "
