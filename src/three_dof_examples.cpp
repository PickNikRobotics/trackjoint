...
int main(int argc, char** argv) {
  ...
  trackjoint::TrajectoryGenerator traj_gen(kNumDof, timestep, desired_duration,
  ...
  trackjoint::ErrorCodeEnum error_code = traj_gen.InputChecking(
      current_joint_states, goal_joint_states, limits, timestep);
  ...
  new(&traj_gen) trackjoint::TrajectoryGenerator(kNumDof, timestep, desired_duration,
                                           kMaxDuration, current_joint_states,
                                           goal_joint_states, limits);

  error_code = traj_gen.InputChecking(
      current_joint_states, goal_joint_states, limits, timestep);
