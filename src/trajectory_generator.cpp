...
void TrajectoryGenerator::SaveTrajectoriesToFile(const std::vector<std::vector<TrajectoryWaypoint>> &output_trajectories, const std::string &base_filepath) const
{
